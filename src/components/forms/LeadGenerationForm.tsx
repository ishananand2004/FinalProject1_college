            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="E.g. John Doe" {...field} required className="bg-[#efefef]"/>
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Bengaluru" {...field} className="bg-[#efefef]"/>
                  </FormControl>
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="email" placeholder="E.g. john@doe.com" {...field} required className="bg-[#efefef]"/>
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
