    ...
    <div className="container mx-auto p-4">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        ...
        <div className="flex flex-col w-full lg:w-1/3 lg:items-end space-y-2">
          <Button
            variant="default"
            className="flex-1 w-full lg:w-[300px] py-3 mt-10"
          >
            Book Appointment
          </Button>
          <Button
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex flex-wrap space-x-0 space-y-3 sm:space-y-0 sm:space-x-4">
              <Button
                className={`w-full sm:w-auto py-2 px-4 text-sm font-semibold rounded-md ${
                  activeSection === "Education" ? "text-white" : "text-white"
                } hover:scale-95`}
              ...
              <Button
                className={`w-full sm:w-auto py-2 px-4 text-sm font-semibold rounded-md ${
                  activeSection === "Honours" ? "text-white" : "text-white"
                } hover:scale-95`}
              ...
              {activeSection === "Education" && (
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    />
                    <p className="ml-3 text-gray-900 text-sm">
                      MS, Kasturba Medical College, Mangalore
                    </p>
                  </div>
                  <div className="flex items-start">
                    <Icon
              ...
              {activeSection === "Honours" && (
                <div>
                  ...
                  <p className="text-gray-900 text-sm">
                    Padma Bhushan, 2012. Padma Shri Award for Medicine in 2004.
                    Karnataka Ratna Award in 2001. Rajyotsava Award in 2002. Sir
                    M. Visvesvaraya Memorial Award in 2003. Ernst & Young
                    Entrepreneur of the Year in 2003. Dr. B.C. Roy Award for
                    2003. Schwab Foundation&apos;s award in 2005.
                  </p>
                </div>
              )}
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <p className="ml-3 text-gray-900 text-sm">
                      ...
                      Cardiac Sciences (RTIICS), Kolkata
                    </p>
                  </div>
                </div>
              )}
